...
import getConstants from '@salesforce/apex/AddLineItemCtrl.getConstants';
    ...
    setOpportunityData(opportunity, lineItemSummary) {
        ...
        this.setData({
            ...
            opportunityInfo: {
                ...
                Customer__c: opportunityKeys.includes('Customer__c') ? opportunity.Customer__c : null,
                Interested_In_Loyalty__c: opportunityKeys.includes('Interested_In_Loyalty__c') ? opportunity.Interested_In_Loyalty__c : null,
                Reason_not_Interested_in_Loyalty__c: opportunityKeys.includes('Reason_not_Interested_in_Loyalty__c') ? opportunity.Reason_not_Interested_in_Loyalty__c : null,
                Loyalty_Program_Type__c: opportunityKeys.includes('Loyalty_Program_Type__c') ? opportunity.Loyalty_Program_Type__c : null,
                dealerChannel : opportunityKeys.includes('Dealership_Channel__c') ? opportunity.Dealership_Channel__c : this.state.opportunityInfo.dealerChannel,
                Tier__c : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.Tier__c : this.state.opportunityInfo.Tier__c,
                Points_Balance__c : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.Points_Balance__c : this.state.opportunityInfo.Points_Balance__c,
                Loyalty_Bonus__c  : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.Loyalty_Bonus__c  : this.state.opportunityInfo.Loyalty_Bonus__c ,
                COMM_Tier__c : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.COMM_Tier__c : this.state.opportunityInfo.COMM_Tier__c,
                COMM_Points_Balance__c : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.COMM_Points_Balance__c : this.state.opportunityInfo.COMM_Points_Balance__c,
                COMM_Available_Bonus__c : opportunityKeys.includes('Customer__r') ? opportunity.Customer__r.COMM_Available_Bonus__c : this.state.opportunityInfo.COMM_Available_Bonus__c
            },
            // Generate Header Details
        ...
        */
        ...
        if(this.state.opportunityInfo.dealerChannel){
            this.setData({ addSchemes: { isCommercial : 
                (this.state.opportunityInfo.dealerChannel && 
                    (this.state.opportunityInfo.dealerChannel === 'Commercial')) ? true : false } });
        }else{
            this.setData({ addSchemes: { isCommercial : false } });
        }
