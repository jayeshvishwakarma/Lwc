...
export default class MultiSelectPicklistForm extends LightningElement {
    ...
    selectRecord(event) {
        ...
        console.log('==  this.currentSelectedValue.length ', this.currentSelectedValue.length);
        ...
        if (this.currentSelectedValue.length === this.maxLimit) {
            ...
            console.log('== selectedVal ', currentSelectedLabel);
            if (currentSelectedLabel) {
                this.currentSelectedValue.push(currentSelectedLabel);
            }
        }
        console.log('==  this.currentSelectedValue ', this.currentSelectedValue);

        this.dispatchEvent(new CustomEvent('select', { detail: { selectedQuesData: this.currentSelectedValue, indexKey: this.indexKey } }));
