...
import tcu_Detail_Not_Found from '@salesforce/label/c.TCU_Details_Doesnt_exist';
        ...
        getAssetDetails(params)
            .then(result => {
                ...
                if (result.code === 200) {
                    ...
                    if (jsonResponse.tcuDetails && jsonResponse.tcuDetails.vin) {
                        ...
                        this.showSpinner = false;
                        this.errorMessage = tcu_Detail_Not_Found;
                        this.handleMessage('Something is wrong', tcu_Detail_Not_Found, 'error');
                    }
                } else {
                    this.showSpinner = false;
