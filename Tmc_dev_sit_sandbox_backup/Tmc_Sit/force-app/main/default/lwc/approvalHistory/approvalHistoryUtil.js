  ...
  APPROVE: {
    ...
    toastInfo: {
      ...
      error: {
        ...
        title: "Error!",
        message:
          "There was an error while approving the step. Please ensure that the comments have been entered. If problem persists then please contact your System Administrator.",
        variant: "error"
      }
    }
  ...
  REJECT: {
    ...
    toastInfo: {
      ...
      error: {
        ...
        title: "Error!",
        message:
          "There was an error while rejecting the step.Please ensure that the comments have been entered. If problem persists then please contact your System Administrator.",
        variant: "error"
      }
    }
