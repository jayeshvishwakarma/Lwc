({
    ...
    populateURLs: function(component, event, helper){
        ...
        var userChannel = component.get("v.simpleRecord.Dealership_Channel__c");
        var device = $A.get("$Browser.formFactor");
        
        if(userChannel == 'Commercial'){
            if(device==='DESKTOP' || device==='TABLET'){
                pdfUrl+='/apex/CommercialBookingBCRFormPDF?id='+component.get('v.recordId');
            }else{
                pdfUrl+='/dealers/apex/ComBookingBCRFormPDFMobile?id='+component.get('v.recordId');
            }
        }else{
