...
export default class updateCaseCategory extends NavigationMixin(LightningElement) {
    ...
    handleFieldChange(event){
        try{         
            ...
            console.log('this.valuesObj.businessAreaValue-->'+this.valuesObj.businessAreaValue);
            if(fieldValue){
    ...
    handleSubmit(event){
        try{
            ...
            if(this.caseId){
                ...
                console.log('fields.Business_Area__c-->'+fields.Business_Area__c);
