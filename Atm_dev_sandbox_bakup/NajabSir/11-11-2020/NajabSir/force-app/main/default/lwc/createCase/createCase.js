...
export default class CreateCase extends NavigationMixin(LightningElement) {
    ...
    getObjectDetails({
        ...
        if (data) {
            ...
            //console.log(data.recordTypeInfos.values());
    ...
    connectedCallback() {
        ...
        if (this.parentRecordId && this.parentRecordId.length > 18) {
            ...
            if (this.serviceHistoryJsonObj && this.serviceHistoryJsonObj['asset']) {
                ...
                if(this.serviceHistoryJsonObj.ftirDetails.length === 1){
                    this.valuesObj.ftirNumber = this.serviceHistoryJsonObj.ftirDetails[0].ftirNumber;
                }
    ...
    suzukiConnectDetails() {
        if (this.suzukiConnectAssetData) {
            ...
            console.log(JSON.stringify(this.suzukiConnectAssetData));
            ...
            getDealerDetails({
                ...
                .then(result => {
                    console.log('Inside getDealerDetails');
                    console.log(result);
                    if (result) {
    ...
    getOnloadInfo() {
        try {
          //  console.log('Test:- ' + this.parentRecordId);
            this.error = '';
        ...
        try {
            ...
            /****************************************************************************/
                ...
                if (fieldName && this.isFieldChangeReady) {
                    ...
                    if (this.valuesObj.caseTypeValue === 'Internal') {
                        console.log('Internal type case');
                        this.valuesObj.businessAreaValue = 'Internal';
                    }
    ...
    handleSubmit(event) {
        try {
            ...
            console.log('variantid'+this.valuesObj.enquiryVariantId);
            ...
            if (this.suzukiConnectAssetData && (fields.Primary_Category__c === 'Suzuki Connect Product Complaint' ||
                ...
                .then(result => {
                    ...
                    if (result) {
                        ...
                        fields.Model__c = 'CI'; //(do not check in this line to git) This line need to be removed and above line need to be uncommented once working API received
                        ...
                        fields.TCU_Customer_Country__c=this.valuesObj.tcuCustomerCountry;
                        fields.TCU_Customer_State__c=this.valuesObj.tcuCustomerState;
                        fields.TCU_No__c=this.suzukiConnectAssetData.tcuImeiNumber;
                        ...
                        console.log(this.valuesObj.tcuCustomerState);
    ...
    setDefaultValues(fields) {
        ...
        // Added NCH Checkbox check
        if(fields.Origin === 'Top Management' || fields.Origin === 'Inbound' || fields.Origin === 'NCH') {
           // fields.NCH_Flag__c = true;
        }
        return fields;
    }
    ...
    handleAssetFilterChange(event) {
        ...
        console.log('this.valuesObj.enquiryVariantId-->'+this.valuesObj.enquiryVariantId);
    }
