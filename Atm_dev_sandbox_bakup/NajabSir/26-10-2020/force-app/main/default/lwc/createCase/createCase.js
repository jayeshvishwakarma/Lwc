...
export default class CreateCase extends NavigationMixin(LightningElement) {
            ...
            getOnloadInfo({
                ...
                .then(result => {
                    if (result) {
                        ...
                        // Added by Najab Maghirbi 23-October-2020
    ...
    setDealerInfo(dealerAccount){
        ...
        if(dealerAccount.Id){
           // console.log('dealer Id '+dealerAccount.Id);
            ...
            this.valuesObj.dealerCode = dealerAccount.Dealer_Code__c;
    ...
    setEnquiryInfo() {
        if (this.enquiry) {
            ...
            if (this.enquiry.Dealership__c) {
                ...
                this.valuesObj.dealerCode = this.enquiry.Dealership__r.Dealer_Code__c;
    ...
    setCustomerDetailInfo(surveyTakerCustomer){
        if(surveyTakerCustomer.surveyCaseMapping){
            this.valuesObj.channelValue = surveyTakerCustomer.surveyCaseMapping.Channel__c;
            this.valuesObj.caseTypeValue = surveyTakerCustomer.surveyCaseMapping.Case_Type__c;
            this.valuesObj.businessAreaValue = surveyTakerCustomer.surveyCaseMapping.Business_Area__c;
        }
        if(surveyTakerCustomer.customerDetail){
            if (surveyTakerCustomer.customerDetail.FirstName) {
                this.valuesObj.customerFirstName = surveyTakerCustomer.customerDetail.FirstName;
            }
            if (surveyTakerCustomer.customerDetail.MiddleName) {
                this.valuesObj.customerMiddleName = surveyTakerCustomer.customerDetail.MiddleName;
            }
            if (surveyTakerCustomer.customerDetail.LastName) {
                this.valuesObj.customerLastName = surveyTakerCustomer.customerDetail.LastName;
            }
            if (surveyTakerCustomer.customerDetail.PersonMobilePhone) {
                this.valuesObj.customerMobile = surveyTakerCustomer.customerDetail.PersonMobilePhone;
            }
            if (surveyTakerCustomer.customerDetail.PersonEmail) {
                this.valuesObj.customerEmail = surveyTakerCustomer.customerDetail.PersonEmail;
            }
        }
    }
