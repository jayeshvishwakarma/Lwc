...
import {
    getObjectInfo
} from 'lightning/uiObjectInfoApi' // Added for getting object detail (Suzuki connect by Sunit)
...
import panasonicQueueId from '@salesforce/label/c.Panasonic_Queue';
    ...
    connectedCallback() {
        ...
        if (this.parentRecordId && this.parentRecordId.length > 18) {
            ...
            if (this.serviceHistoryJsonObj && this.serviceHistoryJsonObj['asset']) {
                this.valuesObj.Vehicle_Registration_Number__c = this.serviceHistoryJsonObj.asset.Registration_Number__c;
                this.valuesObj.VIN_No__c = this.serviceHistoryJsonObj.asset.VIN__c;
        ...
        try {
            ...
            if (this.suzukiConnectAssetData &&(fields.Primary_Category__c==='Suzuki Connect Product Complaint' ||
             ...
             fields.Primary_Category__c==='Suzuki Connect Dealer Assistance' )) {
                ...
                console.log(fields.Primary_Category__c);
                ...
                fields.Pin_Code__c = this.suzukiConnectAssetData.pincode;
                ...
                fields.OwnerId = panasonicQueueId;
                fields.Assigned_Date__c=new Date();
                fields.EntitlementId='5501s0000004F7w';// Meed to be put in custom label
